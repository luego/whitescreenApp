...
export const copy: Record<Locale, Copy> = {
  en: {
    ...
    more:"More tools",other:"Try other colors",footer:"Made to look good on every screen.",language:"Language",light:"Light theme",dark:"Dark theme",system:"System theme",
  },
  de: {
    ...
    more:"Weitere Werkzeuge",other:"Andere Farben testen",footer:"Für jeden Bildschirm gestaltet.",language:"Sprache",light:"Helles Design",dark:"Dunkles Design",system:"Systemdesign",
  },
  es: {
    ...
    more:"Más herramientas",other:"Prueba otros colores",footer:"Hecho para verse bien en cualquier pantalla.",language:"Idioma",light:"Tema claro",dark:"Tema oscuro",system:"Tema del sistema",
  },
  pt: {
    ...
    more:"Mais ferramentas",other:"Teste outras cores",footer:"Feito para qualquer tela.",language:"Idioma",light:"Tema claro",dark:"Tema escuro",system:"Tema do sistema",
  },
  fr: {
    ...
    more:"Plus d’outils",other:"Tester d’autres couleurs",footer:"Conçu pour tous les écrans.",language:"Langue",light:"Thème clair",dark:"Thème sombre",system:"Thème système",
  },
  it: {
    ...
    more:"Altri strumenti",other:"Prova altri colori",footer:"Progettato per ogni schermo.",language:"Lingua",light:"Tema chiaro",dark:"Tema scuro",system:"Tema di sistema",
  },
  nl: {
    ...
    more:"Meer hulpmiddelen",other:"Probeer andere kleuren",footer:"Gemaakt voor elk scherm.",language:"Taal",light:"Licht thema",dark:"Donker thema",system:"Systeemthema",
  },
};
